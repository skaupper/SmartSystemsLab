...
add_fileset_file hdc1000-ea.vhd VHDL PATH hdc1000-ea.vhd TOP_LEVEL_FILE
...
add_fileset_file hdc1000-ea.vhd VHDL PATH hdc1000-ea.vhd
add_fileset_file Global-p.vhd VHDL PATH Global-p.vhd
add_fileset_file StrobeGen-ea.vhd VHDL PATH StrobeGen-ea.vhd
...
set_module_assignment embeddedsw.dts.name humid_temp
...
# 
# connection point hdcRdy
# 
add_interface hdcRdy conduit end
set_interface_property hdcRdy associatedClock clk
set_interface_property hdcRdy associatedReset ""
set_interface_property hdcRdy ENABLED true
set_interface_property hdcRdy EXPORT_OF ""
set_interface_property hdcRdy PORT_NAME_MAP ""
set_interface_property hdcRdy CMSIS_SVD_VARIABLES ""
set_interface_property hdcRdy SVD_ADDRESS_GROUP ""

add_interface_port hdcRdy iHdcRdy interrupt Input 1
